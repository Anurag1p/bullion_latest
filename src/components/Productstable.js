...
const Productstable = (props) => {
  ...
  return (
    <TableContainer component={Paper}>
       <Table aria-label="collapsible table">
        <TableHead>
          <TableRow >
            ...
            <TableCell align="left">B V Formula</TableCell>
            <TableCell align="left">Metalor Formula</TableCell>
            {/* <TableCell align="left">Per Gm.</TableCell> */}
            <TableCell align="left">Pamp  Formula</TableCell>
            <TableCell align="left">V Suisse Formula</TableCell>
       ...
       <TableCell align="left">{e.bbp_o_competitor_best_value_value}</TableCell>
       <TableCell align="left">{e.bbp_o_competitor_metalor_value}</TableCell>
       {/* <TableCell align="left">{e.per_gm.toString().substring(10, e.per_gm.length - 1)}</TableCell> */}
       <TableCell align="left">{e.bbp_o_competitor_pamp_value}</TableCell>
       <TableCell align="left">{e.bbp_o_competitor_v_suisse_value}</TableCell>
       <TableCell align="left">{e.description}</TableCell>
       <TableCell align="left">{e.quant}</TableCell>
     </TableRow>
       ) }
 ...
 {/* <button className="download_invoice">Download Invoice</button> */}
      <Table aria-label="collapsible table">
        ...
        <TableBody>
        <TableCell align="left">{ datavalues.agreeprice }</TableCell>
      ...
      {/* <button onClick={()=> console.log(datavalues) } >console</button> */}
    </TableContainer>
  );
}
